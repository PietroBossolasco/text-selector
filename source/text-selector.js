            ...
            if(!d.disabled){
                ...
                c.forEach(e => {
                    if(e.innerText){
                        ...
                        if(e.disabled){
                            sel.classList='text-selector-selection text-selector-disabled';
                        }
                        else if(e.selected){
                            sel.classList='text-selector-selection text-selector-selected';
                        }
                        else{
                        ...
                        if(!e.disabled){
                            sel.addEventListener("click", function(){
                                ex=document.getElementsByClassName('text-selector-selected');
                                if (ex[0] != null) {
                                    ex[0].classList='text-selector-selection text-selector-normal';
                                }
                                v=this.innerText;
